# Generated by Django 4.1.5 on 2023-01-22 14:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author_str', models.TextField(blank=True, help_text='List of authors in the format "LastName, GivenName" separated by semi-colons. E.g Smith, John; Klose, Sarah;', null=True, verbose_name='authors')),
                ...
                ('issue', models.IntegerField(blank=True, null=True, verbose_name='issue number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='position', to='literature.author')),
                ('work', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='literature.literature')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('literature', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='supplementary', to='literature.literature', verbose_name='literature')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='authors',
            field=sortedm2m.fields.SortedManyToManyField(blank=True, help_text=None, related_name='works', sort_value_field_name='number', through='literature.WorkAuthor', to='literature.author', verbose_name='authors'),
        ),
        migrations.AddField(
            model_name='literature',
            name='collections',
            field=models.ManyToManyField(blank=True, help_text='Add the entry to a collection.', to='literature.collection', verbose_name='collection'),
        ),
        migrations.AddField(
            model_name='literature',
            name='keywords',
