    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "given",
                    models.CharField(blank=True, max_length=255, null=True, verbose_name="given name"),
                ),
                (
                    "family",
                    models.CharField(blank=True, max_length=255, verbose_name="family name"),
                ),
                (
                    "ORCID",
                    models.CharField(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text=(
                            'List of authors in the format "LastName, GivenName" separated by semi-colons. E.g Smith,'
                            " John; Klose, Sarah;"
                        ),
                        null=True,
                ...
                (
                    "issn",
                    models.CharField(blank=True, max_length=255, null=True, verbose_name="ISSN"),
                ),
                (
                    "isbn",
                    models.CharField(blank=True, max_length=255, null=True, verbose_name="ISBN"),
                ),
                (
                    "issue",
                    models.IntegerField(blank=True, null=True, verbose_name="issue number"),
                ),
                (
                    "label",
                    models.CharField(
                ...
                (
                    "language",
                    models.CharField(blank=True, max_length=2, null=True, verbose_name="language"),
                ),
                (
                    "month",
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text=(
                            "Either a single digit indicating the page number or two hyphen-separated digits"
                            " representing a range."
                        ),
                        max_length=32,
                        null=True,
                        validators=[django.core.validators.RegexValidator("^(\\d+-{1,2}?\\d+)$")],
                        verbose_name="pages",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        ...
                        validators=[
                            ...
                            django.core.validators.MaxValueValidator(literature.utils.get_current_year),
                        ],
                        verbose_name="year",
                    ),
                ),
